...
[-> Release overview](docs/changes/0.2.0.md)

## 0.1.0

- BREAKING: actually throw in non-nullish assertion
- BREAKING: remove cjs build
- Provide an initial skill file
- Removed internal assert implemenation
- Define Panic narrowing helper as static method on class
